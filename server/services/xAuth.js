...
export function getXLoginUrl(state) {
  ...
  // Let twitter-api-v2 handle PKCE generation internally with proper scopes
  const authLink = client.generateOAuth2AuthLink(callbackUrl, {
    scope: ['users.read', 'tweet.read', 'follows.read', 'offline.access'], // Array format for scopes
    state
  });
